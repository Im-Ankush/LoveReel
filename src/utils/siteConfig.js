...
export const ALL_CATEGORIES = [
  { title: 'Valentine Week', pages: [{ path: '/rose-day', label: 'Rose Day', emoji: '🌹' }, { path: '/propose-day', label: 'Propose Day', emoji: '💍' }, { path: '/chocolate-day', label: 'Chocolate Day', emoji: '🍫' }, { path: '/teddy-day', label: 'Teddy Day', emoji: '🧸' }, { path: '/promise-day', label: 'Promise Day', emoji: '🤞' }, { path: '/hug-day', label: 'Hug Day', emoji: '🤗' }, { path: '/kiss-day', label: 'Kiss Day', emoji: '💋' }] },
